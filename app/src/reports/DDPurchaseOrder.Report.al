report 50003 "DD Purchase Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/layouts/DDPurchaseOrder.rdlc';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(ExpectedReceiptDateCaptionLbl; ExpectedReceiptDateCaptionLbl)
                        {
                        }
                        column(ExpectedReceiptDate_PurchLine; Format("Purchase Line"."Expected Receipt Date"))
                        {
                        }
    ...
    var
        ...
        ExpectedReceiptDateCaptionLbl: label 'Exp. Receipt Date';
