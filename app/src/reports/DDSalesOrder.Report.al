report 50001 "DD Sales Order"
{
    RDLCLayout = './src/layouts/DDSalesOrder.rdlc';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(Quantity_Line_Lbl; QuantityCaptionLbl)
                {
                }
                column(ShipQtyCaptionLbl; ShipQtyCaptionLbl)
                {
                }
                column(QtyToShip_Line; Format(Line."Qty. to Ship"))
                {
                }
                column(BackOrderQtyCaptionLbl; BackOrderQtyCaptionLbl)
                {
                }
                column(QtyBackOrder_Line; Format((Line.Quantity - Line."Qty. to Ship") - Line."Quantity Shipped"))
                {
                }
                ...
                begin
                    ...
                    if (Line.Type <> Line.Type::Item) or (NoToShow = '') then
                        NoToShow := Line."No.";
                end;
    ...
    protected var
        ...
        BackOrderQtyCaptionLbl: Label 'Backorder Qty.';
        ShipQtyCaptionLbl: Label 'Ship Qty.';
        UnitPriceCaptionLbl: Label 'Unit Price';
        AmountCaptionLbl: Label 'Amount';
        PromisedDeliveryDateCaptionLbl: label 'Delivery Date';
        QuantityCaptionLbl: Label 'Ordered Quantity';
        NoToShow: Code[20];
